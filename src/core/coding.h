#ifndef _HDB_CODING_H_
#define _HDB_CODING_H_
...
static inline uintmax_t _decode_varint(const unsigned char **bufp)
{
...
{
    char *bp = buf;
    uintmax_t v = _decode_varint((const unsigned char **)&bp);
    if (dst) *dst = bp;
